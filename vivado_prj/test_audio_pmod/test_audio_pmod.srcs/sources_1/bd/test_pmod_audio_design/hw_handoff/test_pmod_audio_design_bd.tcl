...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.CLKOUT1_JITTER {167.017} CONFIG.CLKOUT1_PHASE_ERROR {114.212} CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {50.000} CONFIG.PRIMITIVE {PLL}  ] $clk_wiz_0
  ...
  # Create instance: upsizer_msb_0, and set properties
  set upsizer_msb_0 [ create_bd_cell -type ip -vlnv hepia:user:upsizer_msb:1.0 upsizer_msb_0 ]
  set_property -dict [ list CONFIG.IN_WIDTH {12} CONFIG.OUT_WIDTH {16}  ] $upsizer_msb_0
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins pMOD_Audio_in_0/CLK] [get_bd_pins pMOD_Audio_out_0/clk]
  ...
  connect_bd_net -net pMOD_Audio_in_0_DATA [get_bd_pins pMOD_Audio_in_0/DATA] [get_bd_pins upsizer_msb_0/data_in]
  ...
  connect_bd_net -net pMOD_Audio_out_0_done [get_bd_pins pMOD_Audio_in_0/START] [get_bd_pins pMOD_Audio_out_0/done]
  connect_bd_net -net reset_1 [get_bd_ports reset] [get_bd_pins clk_wiz_0/reset]
  connect_bd_net -net upsizer_msb_0_data_out [get_bd_pins pMOD_Audio_out_0/audio_in] [get_bd_pins upsizer_msb_0/data_out]
